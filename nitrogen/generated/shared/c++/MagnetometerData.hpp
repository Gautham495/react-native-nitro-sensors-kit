...
namespace margelo::nitro::nitrosensorskit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (MagnetometerData).
   */
  struct MagnetometerData final {
  public:
  ...
  public:
    ...
    explicit MagnetometerData(double x, double y, double z, double timestamp): x(x), y(y), z(z), timestamp(timestamp) {}

  public:
    friend bool operator==(const MagnetometerData& lhs, const MagnetometerData& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ MagnetometerData <> JS MagnetometerData (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrosensorskit::MagnetometerData> final {
    static inline margelo::nitro::nitrosensorskit::MagnetometerData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrosensorskit::MagnetometerData(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrosensorskit::MagnetometerData& arg) {
