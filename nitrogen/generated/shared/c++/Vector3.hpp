...
namespace margelo::nitro::nitrosensorskit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (Vector3).
   */
...
namespace margelo::nitro {
  ...
  // C++ Vector3 <> JS Vector3 (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrosensorskit::Vector3> final {
    static inline margelo::nitro::nitrosensorskit::Vector3 fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrosensorskit::Vector3(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrosensorskit::Vector3& arg) {
