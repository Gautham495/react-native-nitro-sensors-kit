...
namespace margelo::nitro::nitrosensorskit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (AccelerometerData).
   */
  ...
  public:
    ...
    explicit AccelerometerData(double x, double y, double z, double timestamp): x(x), y(y), z(z), timestamp(timestamp) {}

  public:
    friend bool operator==(const AccelerometerData& lhs, const AccelerometerData& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ AccelerometerData <> JS AccelerometerData (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrosensorskit::AccelerometerData> final {
    static inline margelo::nitro::nitrosensorskit::AccelerometerData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrosensorskit::AccelerometerData(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrosensorskit::AccelerometerData& arg) {
