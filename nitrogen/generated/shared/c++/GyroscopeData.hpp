...
namespace margelo::nitro::nitrosensorskit {
  ...
  /**
   * A struct which can be represented as a JavaScript object (GyroscopeData).
   */
  struct GyroscopeData final {
  public:
  ...
  public:
    ...
    explicit GyroscopeData(double x, double y, double z, double timestamp): x(x), y(y), z(z), timestamp(timestamp) {}

  public:
    friend bool operator==(const GyroscopeData& lhs, const GyroscopeData& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ GyroscopeData <> JS GyroscopeData (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrosensorskit::GyroscopeData> final {
    static inline margelo::nitro::nitrosensorskit::GyroscopeData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrosensorskit::GyroscopeData(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrosensorskit::GyroscopeData& arg) {
